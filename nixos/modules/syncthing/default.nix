{
  ...
  knownDevices = {
    ...
    rock = {
      ...
      addresses = ["tcp://192.168.88.11:22000" "dynamic"];
    };
    # Desktop
    metal = {
      id = "52PIOYT-JNTOP7M-KEVFHVF-UO4DPFC-EHOJKNY-4DRHKLN-W2QI57L-TT7JSQX";
      addresses = ["tcp://192.168.88.12:22000" "dynamic"];
    };
    # Laptop
    trance = {
...
in {
  options = {
    pbor.syncthing.enable = (lib.mkEnableOption "Enable Syncthing") // {default = config.pbor.enable;};
